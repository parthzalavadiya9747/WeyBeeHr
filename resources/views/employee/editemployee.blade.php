										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="workinghour" placeholder="Enter Working Hour" class="form-control workinghourdigit" maxlength="5" max="24" required="" value="{{  $employee->workinghour }}" autocomplete="off">
